let musicDB = [
  ...
  {
    id: 9,
    name: "Niye Bele Uzundur Bu Yollar",
    author_name: "No Land",
    img: "noland.jpg",
    lang: "Azerbaijani",
    timesPlayed: 0,
    type: "instrumental",
    musicName: "mp3indirdur-No-Land-Niye-Bele-Uzundur-Bu-Yollar.mp3",
    attribution: {
      song: "Niye Bele Uzundur Bu Yollar",
      musicBy: "No Land",
      download: null,
      stream: "https://www.youtube.com/watch?v=6E8oHhWg7m4",
    },
  },
  {
    id: 10,
    ...
    timesPlayed: 0,
    type: "instrumental",
    musicName: "Alan-Walker-Faded-gospelful.com_.mp3",
    attribution: {
      song: "Faded",
      musicBy: "Alan Walker",
      download: null,
      stream: "https://www.youtube.com/results?search_query=faded+alan+walker",
    },
  },
  {
    id: 11,
    ...
    timesPlayed: 0,
    type: "electronic",
    musicName: "mp3indirdur-Edis-Martilar.mp3",
    attribution: {
      song: "Martılar",
      musicBy: "Edis",
      download: null,
  ...
  },
  {
    ...
    timesPlayed: 0,
    type: "instrumental",
    musicName: "Avicii_-_Wake_Me_Up_(Jesusful.com).mp3",
    attribution: {
      song: "Wake Me Up",
      musicBy: "Avicii",
      download: null,
      stream: "https://www.youtube.com/watch?v=IcrbM1l_BoI",
    },
  },
  {
    id: 13,
    name: "Ay ishiginda",
    author_name: "Imamyar Hasanov",
    img: "ay.jpg",
    lang: "Azerbaijani",
    timesPlayed: 0,
    type: "instrumental",
    musicName: "imamyar_Hasanov_Nermine_Memmedova_(getmp3.pro).mp3",
    attribution: {
      song: "Ay ishiginda",
      musicBy: "Imamyar Hasanov",
      download: null,
      stream: "https://www.youtube.com/watch?v=7ylTzg7P9BA",
    },
  },
  {
    id: 14,
    name: "Masum Degiliz",
    author_name: "Seksendört",
    img: "masum.jpg",
    lang: "Turkish",
    timesPlayed: 0,
    type: "electronic",
    musicName: "Seksendrt_-_Masum_Deiliz_JoyTurk_(getmp3.pro).mp3",
    attribution: {
      song: "Masum Degiliz",
      musicBy: "Seksendört",
      download: null,
      stream: "https://www.youtube.com/watch?v=Q9zeLNHJsz8",
    },
  },
  {
    id: 15,
    ...
    timesPlayed: 0,
    type: "electronic",
    musicName: "mp3indirdur-Coolio-Gangstas-Paradise.mp3",
    attribution: {
      song: "Gansta's Paradise",
      musicBy: "Coolio",
      download: null,
      stream: "https://www.youtube.com/watch?v=fPO76Jlnz6c",
    },
  },
  {
    id: 16,
    name: "Bir Derdim Var",
    author_name: "Mor ve ötesi",
    img: "birderdimvar.jpg",
    lang: "Turkish",
    timesPlayed: 0,
    type: "instrumental",
    musicName: "mp3indirdur-Mor-Ve-Otesi-Bir-Derdim-Var.mp3",
    attribution: {
      song: "Bir Derdim var",
      musicBy: "Mor ve ötesi",
      download: null,
      stream: "https://www.youtube.com/watch?v=7RW8n4iXZbA",
    },
  },
  {
    id: 17,
    name: "Rather Be",
    author_name: "Clean Bandit",
    img: "ratherbe.jpg",
    lang: "English",
    timesPlayed: 0,
    type: "electronic",
    musicName: "Clean Bandit — Rather Be (Feat. Jess Glynne).mp3",
    attribution: {
      song: "Rather Be",
      musicBy: "Clean Bandit",
      download: null,
      stream: "https://www.youtube.com/watch?v=m-M1AtrxztU",
    },
  },
  {
    id: 18,
    name: "Əzizim",
    author_name: "Eyyub Yagubov",
    img: "eyyubyaqubov.jpg",
    lang: "Azerbaijani",
    timesPlayed: 0,
    type: "electronic",
    musicName: "Eyyub_Yaqubov_-_zizim_(getmp3.pro).mp3",
    attribution: {
      song: "Əzizim",
      musicBy: "Eyyub Yagubov",
      download: null,
      stream: "https://www.youtube.com/watch?v=6KostEGpTNI",
    },
  },
  {
    id: 19,
    ...
    timesPlayed: 0,
    type: "instrumental",
    musicName: "The Beatles (Битлз) - Eleanor Rigby.mp3",
    attribution: {
      song: "Eleanor Rigby",
      musicBy: "The Beatles",
      download: null,
      stream: "https://www.youtube.com/watch?v=HuS5NuXRb5Y",
    },
  },
  {
    id: 20,
    name: "Zemin",
    author_name: "Emir Can Igrek",
    img: "Zemin.jpg",
    lang: "Turkish",
    timesPlayed: 0,
    type: "electronic",
    musicName: "mp3indirdur-Emir-Can-Igrek-Zemin.mp3",
    attribution: {
      song: "Zemin",
      musicBy: "Emir Can Igrek",
      download: null,
      stream: null,
    },
  },
